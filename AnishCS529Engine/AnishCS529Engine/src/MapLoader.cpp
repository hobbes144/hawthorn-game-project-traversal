...
void MapLoader::zero(float offsetX, float offsetY, float offsetZ, SceneGraph& sceneGraph, std::shared_ptr<Camera> camera, std::shared_ptr<Mesh> floorMesh, std::shared_ptr<Material> floorMaterial){
    ...
    //    LeftWall->setLocalScaling(Vector3(400.0f, 12.0f, 1.0f));
    ...
    //    RightWall->setLocalScaling(Vector3(400.0f, 12.0f, 1.0f));
    ...
    // Floor2 pad
    {
        auto Floor2 = std::make_shared<GameObject>("Floor2");
    ...
    // Floor4 pad
    {
        auto Floor4 = std::make_shared<GameObject>("Floor4");
    ...
    // Floor5 pad
    {
        auto Floor5 = std::make_shared<GameObject>("Floor5");
