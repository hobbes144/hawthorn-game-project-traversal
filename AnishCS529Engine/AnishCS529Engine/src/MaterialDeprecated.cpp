...
//
//void MaterialDeprecated::setShader(std::shared_ptr<Shader> newShader) {
//  shader = newShader;
//}
//
//std::shared_ptr<Shader> MaterialDeprecated::getShader() const {
//  return shader;
//}
//
//void MaterialDeprecated::setTexture(const std::string& name, std::shared_ptr<Texture> texture, unsigned int unit) {
//  if (!textureData) {
...
//}
//
//void MaterialDeprecated::apply() const {
//  shader->use();
//
...
//  auto newMaterial = std::make_shared<MaterialDeprecated>(newShader);
