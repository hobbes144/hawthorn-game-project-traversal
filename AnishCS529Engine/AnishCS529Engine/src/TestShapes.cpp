...
//
//void pushquad(std::vector<VectorTemplated<int, 3>>& Tri, int i, int j, int k, int l)
//{
//  Tri.push_back(VectorTemplated<int, 3>([i, j, k]));
//  Tri.push_back(VectorTemplated<int, 3>([i, k, l]));
//}
//
...
//    Tan.push_back(glm::vec3(1.0f, 0.0f, 0.0f));
//    if (i > 0) {
//      Tri.push_back(VectorTemplated<int, 3>(0, i + 1, i));
//    }
//  }
//  MakeVAO();
//}
...
//glm::vec3 staticNrm;
//glm::vec2 staticTex;
//VectorTemplated<int, 3> staticTri;
//
