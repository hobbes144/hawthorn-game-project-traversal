...
//    soundBoxRB->setDebug(isDebug);
//    soundBoxRB->registerToPhysicsManager(PhysicsManager::Instance());
//    soundBoxRB->setTimeScale(1.0f);
//    soundBoxRB->initialize();
//
...
//            }
//
//            ImGui::SliderFloat("World Timescale", &newWorldTimeScale, 0.0f, 10.0f);
...
//#pragma endregion
//
//        if (newWorldTimeScale != worldTimeScale) {
//            soundBoxRB->setTimeScale(newWorldTimeScale);
//            worldTimeScale = newWorldTimeScale;
//        }
//
