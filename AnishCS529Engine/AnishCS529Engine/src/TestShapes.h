...
//// normal,          VectorTemplated<float, 3>,   attribute #1
//// texture coord,   VectorTemplated<float, 3>,   attribute #2
//// tangent,         VectorTemplated<float, 3>,   attribute #3
////
...
//
//  // Data arrays
//  std::vector<VectorTemplated<float, 4>> Pnt;
//  std::vector<VectorTemplated<float, 3>> Nrm;
//  std::vector<VectorTemplated<float, 2>> Tex;
//  std::vector<VectorTemplated<float, 3>> Tan;
//
//  // Lighting information
//  VectorTemplated<float, 3> diffuseColor, specularColor;
//  float shininess;
//
//  // Geometry defined by indices into data arrays
//  std::vector<VectorTemplated<int, 3>> Tri;
//  unsigned int count;
//
//  // Defined by SetTransform by scanning data arrays
//  VectorTemplated<float, 3> minP, maxP;
//  VectorTemplated<float, 3> center;
//  float size;
//  bool animate;
//
